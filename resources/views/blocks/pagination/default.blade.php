@if ($paginator->hasPages())
    <nav>
        <ul class="pagination">
            ...
            @else
                <li>
                    <a class="pagination__item" href="{{ $paginator->previousPageUrl() }}" rel="prev" aria-label="@lang('pagination.previous')">&lsaquo;</a>
                </li>
            @endif
            ...
            @if ($paginator->hasMorePages())
                <li>
                    <a class="pagination__item" href="{{ $paginator->nextPageUrl() }}" rel="next" aria-label="@lang('pagination.next')">&rsaquo;</a>
                </li>
            @else
